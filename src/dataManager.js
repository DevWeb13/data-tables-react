// function findInOneField(data, searchValue, orderField) {
//   return data.filter((elm) => {
//     return elm[orderField].toLowerCase().includes(searchValue.toLowerCase());
//   });
// }

// function searchInAllFields(data, searchValue) {
//   let result = [];
//   for (const key of Object.keys(data[0])) {
//     result = result.concat(findInOneField(data, searchValue, key));
//   }
//   return [...new Set(result)];
// }

// function findInFields(data, searchValue) {
//   const list = searchValue.split(' ');
//   let result = [];
//   for (let i = 0; i < list.length; i++) {
//     result = result.concat(searchInAllFields(data, list[i]));
//   }
//   return [...new Set(result)];
// }
...
//  *
//  * @param   {String}  searchValue  [searchValue description]
//  * @param   {Array}   data    les données à manuipuler
//  * @param   {Number}  nResults     quantité à afficher
//  * @param   {Number}  start        page de départ
//  * @param   {String}  orderField   champs sur lequel le trie se fait
//  *
...
// ) {
//   let filteredData =
//     searchValue.length === 0 ? data : findInFields(data, searchValue);
//   // function de tri
//   if (start) {
//     const startIndex = start * nResults;
//     filteredData = filteredData.slice(startIndex, startIndex + nResults);
//   }
//   return filteredData;
// }
